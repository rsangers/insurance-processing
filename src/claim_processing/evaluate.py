...
from claim_processing.utils.decision_engines import DummyDecisionEngine, SimpleLLMDecisionEngine
...
def evaluate_decisions(results_dir: str):
    ...
    evaluation_df = pd.DataFrame(evaluation_data, columns=["claim_id", "decision_true", "decision_pred", "reasoning_true", "reasoning_pred"])
...
if __name__ == "__main__":
    ...
    process_and_upload_all_claims(decision_engine=decision_engine, results_dir=results_dir)
